...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/portrait-woman-luxurious-restaurant_23-2150517450.jpg",
          alt: "Guest at restaurant",
        },
        {
        ...
        {
          src: "http://img.b2bpic.net/free-photo/people-having-dinner-luxurious-restaurants_23-2151081852.jpg",
          alt: "Guest at restaurant",
        },
        {
      ...
      marqueeItems={[
        {
          type: "text",
          text: "Seasonal Harvests",
        },
        {
          type: "text",
          text: "Live Jazz Nights",
        },
        {
          type: "text",
          text: "Curated Art Gallery",
        },
        {
          type: "text",
          text: "Fine Wine Pairings",
        },
        {
          type: "text",
          text: "Private Dining",
  ...
  <div id="menu" data-section="menu">
      ...
      products={[
        {
          id: "1",
          name: "Wild-Caught Scallop Carpaccio",
          price: "Market",
        ...
        {
          id: "3",
          name: "Herb-Crusted Heritage Lamb",
          price: "Market",
          imageSrc: "http://img.b2bpic.net/free-photo/meatball-sauce-topped-with-greenery_140725-1813.jpg",
        },
        {
          id: "4",
          name: "Dark Chocolate & Lavender Ganache",
          price: "Market",
          imageSrc: "http://img.b2bpic.net/free-photo/young-female-cook-making-delicious-chocolate-cake-with-cream-white-table_181624-44926.jpg",
        },
        {
          id: "5",
          name: "Roasted Heirloom Beet Salad",
          price: "Market",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-plate-with-different-fruits_1203-529.jpg",
        },
        {
          id: "6",
          name: "Artisanal Cheese & Honey Selection",
          price: "Market",
      ...
      features={[
        {
          ...
          subtitle: "Curated piano and jazz sets.",
          category: "Atmosphere",
          value: "Nightly",
        },
        {
          id: "art",
          title: "Rotating Gallery Walls",
          subtitle: "Local artists on display.",
          category: "Vibe",
          value: "Unique",
        },
        {
          id: "events",
          title: "Intimate Cultural Events",
          subtitle: "Poetry, tasting, workshops.",
          category: "Experience",
          value: "Limited",
        },
      ]}
